    ...
    <div style={{ background: '#060C12', minHeight: '100vh', fontFamily: "'Plus Jakarta Sans', sans-serif", padding: '40px 5%' }}>
      <div style={{ maxWidth: 600, margin: '0 auto' }}>
        ...
        <div style={{ display: 'flex', gap: 12, marginBottom: 20 }}>
          <button onClick={() => nav('/')} style={{ flex: 1, background: 'rgba(255,255,255,.06)', color: '#F0F4F8', border: '1px solid rgba(255,255,255,.1)', borderRadius: 12, padding: 13, fontSize: 14, fontWeight: 600, cursor: 'pointer' }}>
            ← Accueil
          </button>
          <button onClick={() => nav('/rdv')} style={{ flex: 1, background: 'linear-gradient(135deg,#0A8F58,#0D9488)', color: '#fff', border: 'none', borderRadius: 12, padding: 13, fontSize: 14, fontWeight: 700, cursor: 'pointer' }}>
            + Nouveau RDV
          </button>
        </div>
