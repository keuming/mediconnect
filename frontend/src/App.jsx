...
import ScanAccueil from './pages/ScanAccueil';
...
import DashboardDentaire         from './pages/dentaire/Dashboard';
      ...
      <BrowserRouter>
        ...
        <Suspense fallback={<Loader />}>
          <Routes>
            ...
            <Route path="/scan-accueil" element={<ScanAccueil />} />
            ...
            {/* ── Cabinet Dentaire ──────────────────────────────── */}
            <Route path="/dentaire/*" element={
              <PrivateRoute roles={['dentaire','admin']}>
                <DashboardDentaire />
              </PrivateRoute>
            } />
